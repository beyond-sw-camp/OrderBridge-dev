...
const fetchPurchaseOrderSituationList = async () => {
  try {
    ...
    const response = await axios.get(`purchaseOrder/situation`, {
...
const excelDown = async () => {
  ...
  try {
    ...
    const response = await axios.get(`purchaseOrder/situation/excelDown`, {
      params: filteredParams,
      paramsSerializer: (params) => {
        return new URLSearchParams(params).toString();
      },
      ...
      <div id="print-area" class="content">
        <div class="table-container">
          ...
          <table>
            ...
            <tbody v-else>
            <tr>
              <td colspan="6">해당 검색조건에 부합한 발주서가 존재하지 않습니다</td>
            </tr>
            </tbody>
            <!-- 총합 -->
