<script setup>
import PurchaseOrderInputForm from "@/components/purchaseOrder/PurchaseOrderInputForm.vue";
import PurchaseOrderInputItems from "@/components/purchaseOrder/PurchaseOrderInputItems.vue";
...
<template>
  <h4 class="title">주문관리 > 발주서 등록</h4>
  <div class="d-flex justify-content-center">
    <PurchaseOrderInputForm ref="childRef"
  ...
  <div class="d-flex justify-content-center">
    <PurchaseOrderInputItems :itemList="itemList"
