...
import ProductionReceivingInputItems from "@/components/productionReceiving/ProductionReceivingInputItems.vue";
...
<template>
  <h4 class="title">생산관리 > 생산입고 등록</h4>
    ...
    <ProductionReceivingInputForm ref="childRef"
